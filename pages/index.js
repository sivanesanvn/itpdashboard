    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 to-blue-700 flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">NDT Portal</h1>
          <p className="text-blue-200 text-sm mt-1">Singapore · Inspection Management System</p>
        </div>

        <div className="bg-white rounded-2xl shadow-xl p-6 mb-4">
          <h2 className="text-base font-semibold mb-4 text-gray-800">Sign in</h2>
          <form onSubmit={handleLogin} className="space-y-3">
            ...
            <button type="submit" disabled={loading} className="btn btn-primary w-full justify-center py-2 mt-1">
              {loading ? 'Signing in…' : 'Sign in →'}
            </button>
          </form>
          <p className="text-xs text-gray-400 text-center mt-4">Access is by invitation. Your NDT manager will send your credentials.</p>
        </div>
